...
Game Developer / Technical Designer with 8+ years experience in systemic gameplay, management sims, stealth-action systems, and narrative-driven design.  
...
- Hide in bushes and water to ambush enemies  
- Use hair to grab, throw, and manipulate objects and enemies  
...
- Combat: attack, dodge, parry, block, throw  
- AI: investigation, communication, search behavior  
- Stealth: shadows, bushes, distractions  
- Social stealth: disguises and crowd blending  
- Environment: destructible lights, vegetation  
...
- Open-ended, nonlinear level design  
- Verticality via grappling hooks and ziplines  
...
- Built recursive enemy system based on player behavior  
- Developed full prototype in one weekend  
- Created minimal sci-fi aesthetic using Unity HDRP  
...
- Designed and implemented full prototype  
- Built AI reacting to player behavior  
